...
If you want Ralph to follow specific requirements for a feature, add a spec file here. Plain English is fine. Most people skip this and describe what they want during `/ralph-plan` instead.

### `sprint_plan.md` — Don't edit this directly

Generated by `/ralph-plan`, executed by `/ralph-continuous`. You can read it anytime to see progress.
