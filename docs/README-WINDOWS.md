...
Keep chatting in the same Claude window — describe what you expected vs. what you see. Ralph may fix it directly or add follow-up tasks to sprint_plan.md. Be mindful of context window length; if the conversation gets long, start a fresh session with `/ralph` instead.
